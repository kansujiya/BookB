	...
	<table class="td font-family email-order-details" cellspacing="0" cellpadding="6" border="0" style='color: #414141; border: 0; vertical-align: middle; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; width: 100%;' width="100%">
		...
		<tfoot>
			...
			<tr class="order-totals order-totals-payment_method order-totals-last">
				...
				<td class="td text-align-right" style="color: #414141; border: 0; vertical-align: middle; text-align: right; padding: 8px 12px; font-weight: normal; padding-top: 5px; border-bottom: 1px solid rgba(0,0,0,.2); padding-bottom: 24px; padding-right: 0;" align="right">Razorpay (UPI/Card/NetBanking)</td>
			</tr>
		</tfoot>
	</table>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="email-additional-content" style='color: #111; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; padding: 32px 0 0; background-color: #FEF9C3; padding: 24px; border-radius: 8px;'>
			...
			<p style="text-align: center; margin: 0 0 16px; color: #713F12;" align="center">You will receive another email with the download link once your access has been granted.</p>
		</td>
	</tr>
</table>
<br>
